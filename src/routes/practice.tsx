    ...
    return renderPage(
      ...
      <div class="text-center py-20">
        ...
        <p class="mt-2 text-ink-soft">
          Hubungi pembuat sesi untuk membukanya kembali.
        </p>
      </div>,
    );
  }
      ...
      <div x-data="typingApp()" class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-6">
          ...
          <p class="mt-1 text-sm text-ink-soft">
            {s.duration_seconds} detik · <span x-text="participantCount"></span>{" "}
            peserta
          </p>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-5">
              ...
              <template x-if="!nickname">
                <div>
                  ...
                  <p class="mt-3 text-xs text-ink-soft">
                    Kamu boleh mencoba ulang berapa saja — papan skor
                    menampilkan skor terbaik per nama.
                  </p>
                </div>
              </template>
              ...
              <template x-if="nickname && !started">
                <div class="text-center py-8">
                  ...
                  <p class="text-sm text-ink-soft mb-6">
                    Teks akan muncul dan timer {s.duration_seconds} detik
                    langsung berjalan saat kamu mulai mengetik.
                  </p>
                  <button
                    {...{ "@click": "begin()" }}
                ...
                <div>
                  ...
                  <div class="flex items-center justify-between mb-5">
                    <span
                      ...
                      {...{
                        ":class":
                          "remaining <= 5 ? 'text-red-600' : 'text-ink-soft'",
                      }}
                    >
                      <span
                        ...
                        {...{
                          ":class":
                            "remaining <= 5 ? 'bg-red-500' : 'bg-accent'",
                        }}
                      ></span>
            ...
            <div class="text-sm text-ink-soft leading-relaxed bg-surface rounded-2xl border border-line p-5">
              ...
              <p>
                Skor = WPM × (akurasi/100)². Kecepatan saja tidak cukup —
                mengetik cepat tapi banyak salah justru menurunkan skor.
              </p>
            </div>
          </div>
          ...
          <div class="bg-surface rounded-2xl border border-line shadow-card h-fit sticky top-20">
            ...
            <div
              x-ref="board"
              class="max-h-[420px] overflow-y-auto p-4 space-y-1"
            >
              <template
                x-for="(row, i) in leaderboard"
                {...{ ":key": "row.nickname" }}
              >
                <div
                  ...
                  {...{
                    ":class":
                      "row.isYou ? 'bg-accent-soft border border-accent/30' : i % 2 === 0 ? 'bg-base/60' : ''",
                  }}
                >
                  <span
                    ...
                    {...{
                      ":class":
                        "i === 0 ? 'text-amber-500 font-bold' : i === 1 ? 'text-zinc-400 font-bold' : i === 2 ? 'text-orange-400 font-bold' : 'text-ink-soft'",
                    }}
                  >
                    <template x-if="i < 3">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p
                      ...
                      x-text="row.wpm + ' WPM · ' + row.accuracy + '%'"
                      x-show="row.attempts > 0"
                    ></p>
                  </div>
                  <span
              ...
              <p
                ...
                class="text-center text-sm text-ink-soft py-8"
              >
...
practiceApi.post("/api/s/:slug/result", async (c) => {
  ...
  if (
    !Number.isFinite(totalTyped) ||
    totalTyped < 0 ||
    totalTyped > s.text_content.length ||
